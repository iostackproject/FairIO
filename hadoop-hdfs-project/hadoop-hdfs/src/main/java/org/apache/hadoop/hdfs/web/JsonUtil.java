...
public class JsonUtil {
  ...
  private static Map<String, Object> toJsonMap(final ExtendedBlock extendedblock) {
    ...
    m.put("classId", extendedblock.getClassId());
  ...
  private static ExtendedBlock toExtendedBlock(final Map<?, ?> m) {
    ...
    final long classId = (Long)m.get("classId");
    return new ExtendedBlock(blockPoolId, blockId, numBytes, generationStamp, classId);
  }
