...
public class PBHelper {
  ...
  public static BlockProto convert(Block b) {
    return BlockProto.newBuilder().setBlockId(b.getBlockId())
        .setGenStamp(b.getGenerationStamp()).setNumBytes(b.getNumBytes()).setClassId(b.getClassId())
        .build();
  }

  public static Block convert(BlockProto b) {                 // TODO FIXED BlockProto es genera automaticament per PB i shaura de comprovar que hi surt el getClassId
    return new Block(b.getBlockId(), b.getNumBytes(), b.getGenStamp(), b.getClassId());
  }
  ...
  public static ExtendedBlock convert(ExtendedBlockProto eb) {
    ...
    return new ExtendedBlock(eb.getPoolId(),  eb.getBlockId(),   eb.getNumBytes(),
       eb.getGenerationStamp(), eb.getClassId());
  }
  ...
  public static GetXAttrsResponseProto convertXAttrsClResponse(
    List<XAttr> xAttrs) {
    GetXAttrsResponseProto.Builder builder = GetXAttrsResponseProto
      .newBuilder();
    if (xAttrs != null) {
