...
public class ReplicaBeingWritten extends ReplicaInPipeline {
   ...
   */
  public ReplicaBeingWritten(long blockId, long genStamp, long classId,
        FsVolumeSpi vol, File dir) {
    super( blockId, genStamp, classId, vol, dir);
  }
   ...
   * @param writer a thread that is writing to this replica
   */
  public ReplicaBeingWritten(long blockId, long len, long genStamp, long classId,
      FsVolumeSpi vol, File dir, Thread writer ) {
    super( blockId, len, genStamp, classId, vol, dir, writer);      // TODO FIXED
  }
