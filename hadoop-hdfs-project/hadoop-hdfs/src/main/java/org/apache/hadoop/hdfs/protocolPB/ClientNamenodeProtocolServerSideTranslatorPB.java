...
public class ClientNamenodeProtocolServerSideTranslatorPB implements
  ...
  @Override
  public GetXAttrsResponseProto getXAttrsCl(RpcController controller, XAttrProtos.GetXAttrsClassIdRequestProto req) throws ServiceException {
    try {
      return PBHelper.convertXAttrsResponse(server.getXAttrsCl(req.getClassId(),req.getId()));
    } catch (IOException e) {
      throw new ServiceException(e);
    }
  }
