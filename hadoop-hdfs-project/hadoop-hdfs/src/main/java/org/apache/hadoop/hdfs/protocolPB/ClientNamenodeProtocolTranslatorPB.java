...
import org.apache.hadoop.hdfs.protocol.proto.XAttrProtos.GetXAttrsClassIdRequestProto;
...
public class ClientNamenodeProtocolTranslatorPB implements
  ...
  @Override
  public List<XAttr> getXAttrsCl(long classId, String datanodeId) throws IOException {
    GetXAttrsClassIdRequestProto.Builder builder = GetXAttrsClassIdRequestProto.newBuilder();
    builder.setClassId(classId);
    builder.setId(datanodeId);

    GetXAttrsClassIdRequestProto req = builder.build();
    try {
      return PBHelper.convert(rpcProxy.getXAttrsCl(null, req));
    } catch (ServiceException e) {
      throw ProtobufHelper.getRemoteException(e);
    }
  }
