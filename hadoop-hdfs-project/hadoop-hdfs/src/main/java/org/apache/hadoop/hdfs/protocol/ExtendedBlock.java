...
public class ExtendedBlock {
  ...
  public ExtendedBlock(final String poolId, final long blkid, final long len,
                       final long genstamp) {
    this.poolId = poolId;
    block = new Block(blkid, len, genstamp, 0);
  }

  public ExtendedBlock(final String poolId, final long blkid, final long len,
      final long genstamp, final long classId) {
    this.poolId = poolId;
    block = new Block(blkid, len, genstamp, classId);
  }
  ...
  public void setClassId(final long cid) {
      block.setClassId(cid);
  }
