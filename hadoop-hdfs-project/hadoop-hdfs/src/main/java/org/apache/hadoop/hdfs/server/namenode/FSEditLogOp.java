...
public abstract class FSEditLogOp {
  ...
  public static void blockToXml(ContentHandler contentHandler, Block block) 
    ...
    XMLUtils.addSaxString(contentHandler, "CLASS_ID",
        Long.toString(block.getClassId()));			// TODO TODO 
  ...
  public static Block blockFromXml(Stanza st)
    ...
    long generationStamp = Long.parseLong(st.getValue("GENSTAMP"));
	  long classId = Long.parseLong(st.getValue("CLASS_ID"));            // TODO TODO lectura de block des de xml
    return new Block(blockId, numBytes, generationStamp, classId);
  }
