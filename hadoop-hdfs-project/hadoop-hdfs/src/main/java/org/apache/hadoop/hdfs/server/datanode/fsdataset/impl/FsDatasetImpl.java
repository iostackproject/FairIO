...
class FsDatasetImpl implements FsDatasetSpi<FsVolumeImpl> {
  ...
  public synchronized Block getStoredBlock(String bpid, long blkid)
    ...
    return new Block(blkid, blockfile.length(), gs, -333);  // TODO TODO -333 que poso de classid?
  }
  ...
  private synchronized ReplicaBeingWritten append(String bpid,
    ...
    ReplicaBeingWritten newReplicaInfo = new ReplicaBeingWritten(
        ...
        replicaInfo.getClassId(), v, newBlkFile.getParentFile(), Thread.currentThread());
  ...
  public synchronized ReplicaInPipeline createRbw(ExtendedBlock b)
    ...
    ReplicaBeingWritten newReplicaInfo = new ReplicaBeingWritten(b.getBlockId(), 
        b.getGenerationStamp(), b.getClassId(), v, f.getParentFile());
  ...
  public synchronized ReplicaInPipeline convertTemporaryToRbw(
    ...
    final long classId = b.getClassId();
    ...
    final ReplicaBeingWritten rbw = new ReplicaBeingWritten(
        blockId, numBytes, expectedGs, classId,
  ...
  public synchronized void finalizeBlock(ExtendedBlock b) throws IOException {
		LOG.info("CAMAMILLA FsDatasetImpl finalizeBlock");			// TODO TODO log
  ...
  private synchronized FinalizedReplica finalizeReplica(String bpid,
    ...
    volumeMap.add(bpid, newReplicaInfo);
		LOG.info("CAMAMILLA FsDatasetImpl finalizeBlock added at volumeMap");			// TODO TODO log
    return newReplicaInfo;
  }
  ...
  private void cacheBlock(String bpid, long blockId) {
    ...
    cacheManager.cacheBlock(blockId, bpid, 
        blockFileName, length, genstamp, classid, volumeExecutor);
  }
  ...
  public void checkAndUpdate(String bpid, long blockId, File diskFile,
    ...
    synchronized (this) {
      ...
      final long classId = Block.filename2classId(diskFile.getName());
      ...
      if (memBlockInfo == null) {
        ...
        ReplicaInfo diskBlockInfo = new FinalizedReplica(blockId, 
            diskFile.length(), diskGS, classId, vol, diskFile.getParentFile());
